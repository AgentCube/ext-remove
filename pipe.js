(function(){
  ...
  pipejs.editorStdout.innerHTML = `PipeJs v${version} (c) ${year} - ${year + 1} | <a href="https://repl.it/@AgentCube" target="_blank" style=\"background:transparent;color:white;\">@AgentCube</a><br>JavaScript v${jversion}<br><span style=\"color:orange;background:transparent;\">&gt; </span> `;
